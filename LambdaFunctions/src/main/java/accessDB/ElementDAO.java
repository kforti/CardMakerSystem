...
public class ElementDAO
{
	...
	public ElementDAO(LambdaLogger logger) {
    	this.logger = logger;
		try
		{
			connection = DatabaseConnect.connect();
...
/////////Query Functions:
    ...
    public int addElement(Element element) throws Exception
    {
    	...
    	try {
	    	...
	    	ps.setString(2, element.getPageType());
			ps.setString(3, element.getElementType());
	    	ps.setString(4, element.getTextMessage());
	    	ps.setString(5, element.getTextFont());
			ps.setString(6, element.getImgSrc());
	    	ps.setInt(7, element.getxCoord());
	    	ps.setInt(8, element.getyCoord());
    ...
    public boolean updateElement(Element element) throws Exception
    {
    	try {
			...
			ps.setInt(9, element.getHeight());
			ps.setInt(10, element.getWidth());
			ps.setInt(11, element.getElementId());
